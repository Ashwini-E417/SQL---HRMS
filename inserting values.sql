...
insert into candidate (ename,eloc,ctc,ectc,notice,ph_num,email,jid,doa,app_status,exp) value ("Pratik Gajne","Pune",450000,650000,"LWD-12-08-2024",7946328640,"pratik@gmail.com","j2","2024-06-15","select",4.2);
